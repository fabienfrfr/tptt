...
## Extensions and Common Variants

- **Bidirectional Attention:**
If using bidirectional mode, sum or concatenate outputs according to the downstream task and projection strategy.
- **Gated Attention:**
Tune gating mechanisms and `recurrent_config` for use cases like long-sequence modeling, memory gating, etc.
- **Multi-modal:**
Preprocess and normalize each modality/feature separately, then combine before attention.
