...
In this work, the feature mapping function of linear attention is approximated by DeltaNet~\cite{yang2024parallelizing}. The recurrent update of internal memory states is formulated in two ways, following:
\begin{itemize}
